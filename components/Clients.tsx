...
export default function Clients() {
  return (
    <section id="clientes" aria-labelledby="clients-heading" className="bg-white py-24 px-6 text-center">
      <div className="max-w-3xl mx-auto">
        <h2 id="clients-heading" className="text-5xl md:text-[52px] font-extrabold text-brand-dark leading-tight tracking-tight mb-4">
        ...
        <ul className="flex flex-col text-left list-none" aria-label="Lista de clientes">
          {clients.map((client, i) => (
            ...
            >
              <div className="flex items-center gap-5">
                <span aria-hidden="true" className="text-[11px] font-bold text-gray-300 tracking-wide min-w-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <span aria-hidden="true" className="text-brand-red opacity-0 -translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all">
                  →
                </span>
              </div>
            </li>
